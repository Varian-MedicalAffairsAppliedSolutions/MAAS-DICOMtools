...
namespace DicomTools.Retrieve
{
    ...
    {
        public DicomStoreService(INetworkStream stream, Encoding fallbackEncoding, ILogger logger, DicomServiceDependencies dependencies)
            : base(stream, fallbackEncoding, logger, dependencies)
        {
            m_logger = logger;
        }

        private StoreService StoreService => (StoreService) UserState;
        ...
        public async Task<DicomCStoreResponse> OnCStoreRequestAsync(DicomCStoreRequest request)
        {
            ...
            return await StoreService.OnCStoreRequestAsync(request);
        }
        ...
        public Task OnReceiveAssociationRequestAsync(DicomAssociation association)
        {
            ...
            Logger.LogInformation($"Received association request from AE: {callingAe} with IP: {association.RemoteHost} to AE {calledAe}");
